...
kdataset  <- "./exp/CA7060/dataset_ML.csv.gz"
kexperimento  <- "DR7130"
...
periodos_analisis  <- c(202008,202009, 202010, 202011, 202012, 202101, 202102, 202103, 202105 )
GLOBAL_colores <-  viridis_pal()(length( periodos_analisis ) )

pdf("densidades_orignales_ampliado_ml.pdf")
